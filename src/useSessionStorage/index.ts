...
import type { Options as SessionOptions } from '../utils/store/localStore'
import LocalStore from '../utils/store/sessionStore'
...
export interface Options<T> {
   ...
   */
  defaultValue?: T
  expiresUnit?: SessionOptions['expiresUnit']
}

const useSessionStorage = <T extends any = any>(
  key: string,
  options?: Options<T>,
) => {
